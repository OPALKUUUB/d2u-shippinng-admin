   ...
   const handleChangeMnyInCheck = async (status, id) => {
      ...
      try {
         const response = await fetch(`/api/tracking/fril?id=${id}`, {
            ...
            body: JSON.stringify({ mny_in_check: status ? 0 : 1 }),
         })
         const responseJson = await response.json()
         setData(responseJson.trackings)
         message.success("success!")
   ...
   const handleChangeMnyOutCheck = async (status, id) => {
      ...
      try {
         const response = await fetch(`/api/tracking/fril?id=${id}`, {
            ...
            body: JSON.stringify({ mny_out_check: status ? 0 : 1 }),
         })
         const responseJson = await response.json()
         setData(responseJson.trackings)
         message.success("success!")
   ...
   const handleChangeCancelRefundCheck = async (status, id) => {
      ...
      try {
         const response = await fetch(`/api/tracking/fril?id=${id}`, {
            ...
            body: JSON.stringify({ cancel_refund_check: status ? 0 : 1 }),
         })
         const responseJson = await response.json()
         setData(responseJson.trackings)
         message.success("success!")
...
FrillPage.getLayout = function getLayout(page) {
